...
def click1():
    beans = int(num.get())
    lbl = Label(tab1, font = ("Arial Bold", 12), text = (f"Celsius: {(beans - 32) * 5 / 9}"))
    lbl.grid(column = 0, row = 1)

def click2(): 
    beans2 = int(num2.get())
    lbl2 = Label(tab2, font = ("Arial Bold", 12), text = (f"Fahrenheit: {beans2 * 9 / 5 + 32}"))
...
tab_control.add(tab1, text = "To Celsius")
tab_control.add(tab2, text = "To Fahrenheit")
